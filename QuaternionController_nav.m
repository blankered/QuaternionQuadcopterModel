function output = QuaternionController_nav(u,Params)
...
feedback.acceleration = Params.pos.kp*Error.proportional + Params.pos.kd*Error.dot + Params.pos.ki*Integral.ErrorPos;
