...
syms s DesiredThrust pqr1 pqr2 pqr3

u = [pqr1 pqr2 pqr3];

Desired.OmegaBody  = [pqr1; pqr2; pqr3];

Desired.quat       = eul2quat([0, 0, 0],'ZYX');
...
SDesired.pqrdt = - H * Params.att.Quat.kp * quat.xdt.error(2:4) - (transpose(FuncWdt)*velocity.error + transpose(WT)*velocity.xdt.error) + ...
...
l1 = [px py pz ub vb wb qw qx qy qz p q r CT1   CT2   CT3   CT4   Tdot pqr1 pqr2 pqr3 DesiredThrust];
