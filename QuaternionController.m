...
[Desired.psi, Desired.theta, Desired.phi] = quat2angle(Desired.quat,'XYZ')
...
Desired.pqrdt  = cross(xdt.ForceBar.Inertial,xdt.ForceBarInertial) + cross(xdt.ForceBar.Inertial,xddt.ForceBarInertial)
...
pqrddt = -H*(Params.quat.kp*(quat.xdt.error(2:4).') - Params.quat.kd*(pqrdt - Desired.pqrdt);
